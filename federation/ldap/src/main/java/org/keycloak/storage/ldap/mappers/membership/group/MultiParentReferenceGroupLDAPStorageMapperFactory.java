 ...
 */
public class MultiParentReferenceGroupLDAPStorageMapperFactory extends AbstractLDAPStorageMapperFactory {

    public static final String PROVIDER_ID = "multi-parent-reference-group-ldap-mapper";
    ...
    protected AbstractLDAPStorageMapper createMapper(ComponentModel mapperModel, LDAPStorageProvider federationProvider) {
        return new MultiParentReferenceGroupLDAPStorageMapper(mapperModel, federationProvider, this);
    }
